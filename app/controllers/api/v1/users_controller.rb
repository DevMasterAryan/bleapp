class Api::V1::UsersController < ApplicationController
	skip_before_action :verify_authenticity_token,only: [:apply_credit,:charge_history,:user_last_charge, :checksum,:billing_not_rated, :charging_status,:billing_status, :checksum_add_money,:add_money_transaction_status]
	before_action :authenticate,only: [:apply_credit,:charge_history,:user_last_charge,:billing_not_rated, :checksum,:billing_not_rated, :charging_status,:billing_status,:checksum_add_money,:add_money_transaction_status]
    # include PaytmHelper
